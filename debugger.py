...
if __name__ == '__main__':
    ...
    places_map = VisualizationTools.construct_map(places_map, location_finder.closest_place_coordinates, location_finder.coordinates_list, location_finder.places_list_coordinates)
